...
export const registerStart = createAction(USER_REGISTER_START, props<{registerForm: {email: string, password: string}}>());
export const loginSuccess = createAction(USER_LOGIN_SUCCESS, props<{user: User}>());
export const registerSuccess = createAction(USER_REGISTER_SUCCESS, props<{user: User}>());
